...
- `svc-gralgob` — Secretaría General de Gobierno — **nuevo, agregado 2026-09-21, no estaba en el plan original.** Fase 0 (módulo `atp`, sync de solo lectura) **desplegada en Cloud Run** (2026-09-21) — corrida real contra el Sheet sincronizó 1104 compromisos con 0 errores; panel de negocio pendiente (spec en `draft`)

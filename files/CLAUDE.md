...
- `svc-gralgob` — Secretaría General de Gobierno — **nuevo, agregado 2026-09-21, no estaba en el plan original.** Fase 0 (módulo `atp`, sync de solo lectura) en desarrollo; panel de negocio pendiente (spec en `draft`)
